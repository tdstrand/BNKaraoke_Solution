...
namespace BNKaraoke.DJ.Services
{
    public interface IApiService
    {
        ...
        Task<List<DJQueueItemDto>> GetQueueAsync(string eventId);
        ...
        Task<ReorderSuggestionResponse?> GetReorderSuggestionsAsync(int eventId);
        Task ApplyReorderSuggestionsAsync(ApplyReorderRequest request);
